...
const Settings: React.FC<SettingsProps> = ({ onLogout }) => {
  ...
  const EditProfileModal = () => (
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in">
          ...
          <div className="bg-white w-full max-w-sm rounded-t-3xl sm:rounded-3xl p-6 shadow-2xl animate-in slide-in-from-bottom duration-300 relative z-10">
              {/* Drag Handle */}
  ...
  const SubscriptionModal = () => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in">
            ...
            <div className="bg-white w-full max-w-lg rounded-t-3xl sm:rounded-3xl p-6 shadow-2xl animate-in slide-in-from-bottom duration-300 max-h-[90vh] overflow-y-auto no-scrollbar relative z-10">
                {/* Drag Handle */}
                <div className="w-12 h-1.5 bg-slate-200 rounded-full mx-auto mb-6 shrink-0 sm:hidden"></div>
            ...
            <div className="p-4 flex items-center justify-between">
                ...
                <button 
                    ...
                    className={`px-4 py-1.5 rounded-full text-xs font-bold transition-all ${
                        integrations.instagram ? 'bg-green-100 text-green-700' : 'bg-slate-100 text-slate-600'
                    }`}
                >
