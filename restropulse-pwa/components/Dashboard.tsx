...
import { TrendingUp, Users, ArrowRight, Bell, Calendar, Eye, Tag, UtensilsCrossed, Lock, Activity, Sparkles } from 'lucide-react';
    ...
    <div className="p-4 space-y-6">
      ...
      {pendingCount > 0 && (
        <button 
            ...
            className="w-full bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-4 text-white shadow-lg shadow-orange-500/20 flex items-center justify-between transition-transform active:scale-[0.98]"
        >
      ...
      <div className="space-y-3">
        ...
        {nextScheduled ? (
            <div 
                onClick={() => setView && setView('STUDIO')}
                className="bg-white p-3 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4 cursor-pointer active:scale-[0.98] transition-transform"
            >
                <img src={nextScheduled.thumbnail} alt="Next Post" className="w-16 h-16 rounded-lg object-cover bg-slate-100" />
