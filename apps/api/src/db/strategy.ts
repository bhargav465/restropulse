import { getStrategyCyclesCollection, getContentStrategiesCollection, toApiFormat, toApiFormatArray, toObjectId } from './connection.js';
import { StrategyCycle, ContentStrategy } from '../models/types.js';
...
export async function updateContentStrategy(restaurantId: string, updates: Partial<ContentStrategy>): Promise<ContentStrategy | null> {
    const col = getContentStrategiesCollection();
