...
export const DEFAULT_SUBSCRIPTION_PLANS = [
    {
        ...
        tier: 'STARTER',
        name: 'Starter',
        limits: { weekly: { INSTAGRAM: { IMAGE: 2, STORY: 2, CAROUSEL: 1, REEL: 1, VIDEO: 1 } } },
    ...
    },
    {
        ...
        tier: 'PREMIUM',
        name: 'Premium',
        limits: { weekly: { INSTAGRAM: { IMAGE: 10, STORY: 10, CAROUSEL: 5, REEL: 5, VIDEO: 5 }, FACEBOOK: { IMAGE: 10, CAROUSEL: 5, VIDEO: 5, STORY: 5 } } },
