        ...
        <div className="flex justify-around items-center px-2 pt-1 pb-1">
          ...
          <div className="relative -top-5">
            <button
              ...
              className={`w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-all active:scale-90 active:shadow-xl ${currentView === 'INPUTS' ? 'bg-slate-800 text-white' : 'bg-orange-600 text-white'
                }`}
            >
              <PlusCircle size={28} />
            </button>
