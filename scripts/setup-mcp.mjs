...
async function main() {
    ...
    if (allGood) {
        ...
        console.log('    3. Run `npm run reindex` manually after large code changes if semantic search feels stale');
        console.log('    4. Optional: configure your own local git hooks if you prefer auto-reindex\n');
    } else {
